  ...
  return (
    <Container className="pt-[120px]">
      <div className="grid grid-cols-1 grid-rows-2 items-center justify-between gap-10 text-center md:gap-16 lg:grid-cols-2 lg:grid-rows-1 lg:gap-[125px] lg:text-left">
        <div className="order-2 mx-auto space-y-8 md:max-w-[573px] lg:order-1">
        ...
        <div className="order-1 h-full min-h-[300px] rounded-xl bg-[url('/images/man.png')] bg-cover bg-center bg-no-repeat grayscale-100 lg:order-2"></div>
      </div>
    </Container>
  )
}
